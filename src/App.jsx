...
const App = () => {
  ...
  return (
    <>
      <BrightnessButton changeColor={changeColor} />
      <Title textColor={textColor}>Hey, I'm Thomas.</Title>
      <Body textColor={textColor}>
        I'm a second-year computer science student at the University of
        Waterloo, and an automation software developer at the student design
        team WARG. I have experience in full-stack development and DevOps, and a
        keen interest in machine learning. <br />
        <br /> This summer, I'm interning at Atomic Dev Inc., doing full-stack
        web development using React, Express, PHP, and MySQL.
        <br />
        <br />
        Here's my{" "}
        ...
        .<br />
        <br />
        Outside of school, you can find me yapping in the MC lounge, hitting the
        gym, or waiting in the Tims line for my iced coffee.
        <br />
        <br />
